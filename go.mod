module github.com/conduitio-labs/custom-conduit-app

go 1.24.2

require github.com/conduitio/conduit v0.13.4
...
require (
	...
	github.com/conduitio/conduit-processor-sdk v0.4.2 // indirect
